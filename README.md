...
Proyek ini menggunakan pendekatan **Agentic Retrieval-Augmented Generation**. Alur kerja **Agentic RAG** dalam memproses pertanyaan pengguna secara bertahap dan terstruktur. Proses dimulai dari **User Question**, yaitu pertanyaan yang diajukan pengguna, kemudian sistem melakukan **Context & Intent Analysis** untuk memahami konteks, maksud, serta kebutuhan informasi. Setelah itu, sistem menentukan **Source Selection**, yaitu memilih sumber yang paling sesuai, baik KUHP Baru sebagai sumber hukum utama maupun **External Sources** sebagai sumber pendukung. Informasi yang diperoleh kemudian digabungkan melalui **Information Synthesis** untuk membentuk konteks yang lebih lengkap. Tahap berikutnya adalah **Answer Evaluation**, yaitu mengevaluasi apakah informasi yang tersedia sudah cukup untuk menghasilkan jawaban. Jika informasi dinilai sufficient, sistem menyusun Final Answer dan menyampaikannya kepada pengguna. Namun, apabila informasi masih insufficient, sistem melakukan Retrieval kembali untuk memperoleh informasi tambahan, kemudian mengulang proses pemilihan sumber dan evaluasi. Dengan mekanisme iteratif tersebut, sistem berupaya menghasilkan jawaban yang lebih relevan, kontekstual, akurat, dan berlandaskan sumber informasi yang tersedia. Pendekatan ini memungkinkan agen tidak sekadar mencari kata kunci, tetapi menyesuaikan pencarian dengan kebutuhan pengguna dan memperbaiki hasil ketika bukti atau informasi yang tersedia belum memadai secara optimal. Proses tersebut dapat digambarkan dalam diagram di bawah ini.
...
[![Demo KUHP](assets/Thumbnail_video.png)](https://drive.google.com/file/d/1KDyECTo2E99ip7WzKK5UMxTEovxj-Ftl/view?usp=sharing)
